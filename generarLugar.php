...
<body>
        <?php
            ...
            if (isset($_SESSION['usuario'])) {
                ...
                echo "<center><h1>Bienvenido usuario '". $nombreUsuario ."' al Resgistro de Lugares Turísticos</h1></center>";
            }
        ?>
    
	<form action="resgistrarLugar.php" method="POST">
		Título - Lugar: <input type="text" name="titulo" maxlength="200" required><br/><br/>
    ...
    <form action="gestionLugares.php">
        <button type="submit">Gestionar Lugar</button>
    </form>
    <br/>
